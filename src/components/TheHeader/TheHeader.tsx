...
export default function TheHeader({
  ...
  const fullText =
    'Minkahaus is a renovation project on mountain and forest land north of Kyoto. Building a space for research, exchange and stays that explore mingei, Japanese craft.';
